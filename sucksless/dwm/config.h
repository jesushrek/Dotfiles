...
static const char *fonts[]               = { "monospace:size=11;2","Noto Sans Devanagari UI:size=12","Symbols Nerd Font Mono:size=11:style=Regular" };
...
{
    [DEFAULT_TAGS]        = { "१", "२", "३", "४", "५", "६", "७", "८", "९" },
